...
import com.ctbc.aigo.service.BenefitNotificationsService;
...
@Service
public class BenefitNotificationsServiceImpl implements BenefitNotificationsService {

    final CommonApiUtil commonApiUtil;
    final DmPcoBoAdvisoryRepository dmPcoBoAdvisoryRepository;

    public BenefitNotificationsServiceImpl(CommonApiUtil commonApiUtil, DmPcoBoRightsRepository dmPcoBoRightsRepository, DmPcoBoAdvisoryRepository dmPcoBoAdvisoryRepository) {
